{{-- Square crop for user profile photo (WebP) --}}
<div id="userAvatarCropModal"
     class="hidden fixed inset-0 z-[100] flex items-end justify-center sm:items-center p-0 sm:p-4"
     role="dialog"
     aria-modal="true"
     aria-labelledby="userAvatarCropTitle">
    ...
    <div class="relative flex w-full max-h-[min(96dvh,100svh)] flex-col rounded-t-3xl border border-gray-200 bg-white shadow-2xl sm:max-h-[96vh] sm:max-w-2xl sm:rounded-2xl lg:max-w-3xl">
        <div class="flex shrink-0 items-start justify-between gap-3 border-b border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] sm:px-5 sm:py-4">
            ...
            <button type="button"
                    class="js-user-avatar-crop-cancel -mr-1 shrink-0 rounded-xl p-3 text-gray-500 transition-colors hover:bg-white/90 hover:text-gray-800 active:bg-white min-h-[44px] min-w-[44px]"
                    aria-label="Close">
        ...
        <div class="min-h-0 flex-1 overflow-hidden bg-slate-100 px-3 pb-2 pt-3 sm:px-4 sm:pb-3 sm:pt-4">
            <div id="userAvatarCropStage"
                 class="user-avatar-croppie-stage mx-auto w-full max-w-full overflow-hidden rounded-2xl border border-slate-200 bg-slate-900 shadow-inner
        ...
        <div class="flex shrink-0 flex-col-reverse gap-2 border-t border-gray-200 bg-gray-50 px-4 py-3 sm:flex-row sm:justify-end sm:px-5 sm:py-4"
            ...
            <button type="button"
                    class="js-user-avatar-crop-cancel min-h-[48px] w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-base font-semibold text-gray-800 transition-colors hover:bg-gray-50 active:bg-gray-100 sm:min-h-0 sm:w-auto sm:py-2.5 sm:text-sm">
                {{ __('vendor.cancel') }}
            </button>
            <button type="button"
...
<style>
    .user-avatar-croppie-stage .cr-slider-wrap { margin-top: 0.875rem; padding: 0.5rem 0.25rem 0.25rem; width: 100% !important; max-width: 100%; }
